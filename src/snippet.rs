...
"#;
    ...
    #[test]
    #[allow(non_snake_case)]
    fn addCodeFromNewFile_otherCodes_valid() {
        let snippet_text = r#"// #PORT#
//name:"mock2"
//prefix:"prefix2"
//description:"desc2"
...
"#;
        ...
        // snippet3
        assert_eq!(parsed.contains_key("dump"), true);
        assert_eq!(parsed["dump"].prefix, "dump");
        assert_eq!(parsed["dump"].description, "debug");
        assert_eq!(parsed["dump"].body, expected_body3);
...
////////// [[PortSnippet End]] (DON\'T REMOVE) //////////
        ...
        let mut readers = prepare_reader(
            snippet_text,
            "{\"MOCK_PATH\":[\"just_a_mock\"],\"MOCK2\":[\"mock2\"]}",
            snippet_json,
        );
        let result = make(
            readers.snippet,
